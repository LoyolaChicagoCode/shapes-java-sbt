...
/**
 * A shape visitor for calculating the bounding box,
 * that is, the smallest rectangle containing the
 * shape. The resulting bounding box is returned 
 * as a rectangle at a specific location.
 */
